...
!(function (e, t, n, o, r) {
  ...
  function yo(e, t, n) {
    var o;
    (n = void 0 === n ? {} : n),
      "function" == typeof cn.CustomEvent ? (o = new CustomEvent(t, { detail: n })) : (o = sn.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, n),
      e.dispatchEvent(o);
  }
  function Eo(e, t) {
  ...
  return (
    ...
    function (e, b) {
      var n =
          (b && new RegExp("([\\d\\w]{8}-){3}[\\d\\w]{8}|^(?=.*?[A-Y])(?=.*?[a-y])(?=.*?[0-8])(?=.*?[#?!@$%^&*-]).{8,}$").test(b.licenseKey)) ||
          ...
          w &&
            ...
            b.css3 &&
              (b.css3 = (function () {
                ...
                for (var o in ((t.style.display = "block"), sn.body.insertBefore(t, null), n))
                  void 0 !== t.style[o] && ((t.style[o] = "translate3d(1px,1px,1px)"), (e = cn.getComputedStyle(t).getPropertyValue(n[o])));
            ...
            (b.normalScrollElements.split(",").forEach(function (e) {
              if (!o) {
                var t = Eo(i, e),
                  n = po(i, e);
                (t || n) &&
                  (m.shared.isNormalScrollElement || (ue(!1), r && b.scrollOverflowHandler.setIscroll(i, !1)),
          ...
          1 < n &&
            (b.controlArrows &&
              ...
              "#fff" !== b.controlArrowColor &&
                (Kn(Un(Xn, l), { "border-color": "transparent transparent transparent " + b.controlArrowColor }),
                Kn(Un(Zn, l), { "border-color": "transparent " + b.controlArrowColor + " transparent transparent" })),
      ...
      function Ce() {
        ...
        ao(n, bn),
          ...
          (e.section && t && (void 0 === t || oo(t) !== oo(o))) ||
            !wo(b.afterLoad) ||
            Xe("afterLoad", { activeSection: n, element: n, direction: null, anchorLink: n.getAttribute("data-anchor"), sectionIndex: oo(n, yn) }),
      ...
      function Ve(e) {
        ...
        return (
          y < t ? ((r || l) && "bottom" !== l) || (o = i) : (r || (E && null == to(e))) && (o = i),
      ...
      function Ke(o) {
        b.lazyLoading &&
          Un("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]", nt(o)).forEach(
            function (n) {
              if (
      ...
      function dt(e) {
        ...
        9 === n
          ? (function (e) {
              ...
              (l = Ue(po(i, Hn))),
              (a = Ge(po(i, yn))),
              l || a) && (s ? null == po(s, En + "," + En + " " + zn) && (s = f(e)) : f(e), ((!c && s == u[u.length - 1]) || (c && s == u[0])) && bo(e));
            })(e)
          : Eo(t, "textarea") ||
            Eo(t, "input") ||
            Eo(t, "select") ||
        ...
        (r.xMovement = Ht(r.prevSlideIndex, r.slideIndex)),
          ...
          b.onSlideLeave && !r.localIsResizing && "none" !== r.xMovement && wo(b.onSlideLeave) && !1 === Xe("onSlideLeave", r)
            ...
            : ((Jt("dropEffect") && b.dropEffect) || (ao(t, mn), co(So(t), mn)),
              ...
              b.interlockedSlides &&
                m.interlockedSlides &&
                ((Jt("continuousHorizontal") && void 0 !== n && n !== r.xMovement) || m.interlockedSlides.apply(r)));
      }
      function yt(e) {
      ...
      function kt(e, t) {
        ...
        (n = e),
          ...
          b.navigation &&
            ...
            (co(Un(Sn, Un(On)[0]), mn), ao(o ? Un('a[href="#' + o + '"]', Un(On)[0]) : Un("a", Un("li", Un(On)[0])[r]), mn));
      }
      function Ct(e) {
        var t = oo(Un(En)[0], yn),
          n = oo(e, yn);
      ...
      function Pt(e, t, n, o) {
        var r = "";
        b.anchors.length && !b.lockAnchors && (e ? (null != n && (r = n), null == t && (t = e), Yt(r + "/" + (l = t))) : (null != e && (l = t), Yt(n))),
          Dt();
      }
      function Yt(e) {
      ...
      function tn() {
        ...
        n
          ...
          : (Gn("error", "Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:"),
