...
!(function (e, t, n, o, r) {
  ...
  function $n(e, t, n) {
    var o;
    (n = void 0 === n ? {} : n),
      "function" == typeof zt.CustomEvent ? (o = new CustomEvent(t, { detail: n })) : (o = jt.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, n),
      e.dispatchEvent(o);
  }
  function qn(e, t) {
  ...
  return (
    ...
    function (e, E) {
      var n =
          (E && new RegExp("([\\d\\w]{8}-){3}[\\d\\w]{8}|^(?=.*?[A-Y])(?=.*?[a-y])(?=.*?[0-8])(?=.*?[#?!@$%^&*-]).{8,}$").test(E.licenseKey)) ||
      ...
      function Ee() {
        ...
        Nn(n, _t),
          ...
          (e.section && t && (void 0 === t || In(t) !== In(f))) ||
            !_n(E.afterLoad) ||
            Ne("afterLoad", { activeSection: n, element: n, direction: null, anchorLink: n.getAttribute("data-anchor"), sectionIndex: In(n, qt) }),
      ...
      function De(e) {
        ...
        null != (t = e).wrapAroundElements &&
          (t.isMovementUp ? Fn(yn(qt)[0], t.wrapAroundElements) : Yn(yn(qt)[yn(qt).length - 1], t.wrapAroundElements), Tt(yn(Qt)[0].offsetTop), Be()),
      ...
      function Ye(o) {
        E.lazyLoading &&
          yn("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]", _e(o)).forEach(
            function (n) {
              if (
      ...
      function Ge(e) {
        ...
        9 === n
          ? (function (e) {
              ...
              (l = je(Wn(i, ln))),
              (a = ze(Wn(i, qt))),
              l || a) && (c ? null == Wn(c, Qt + "," + Qt + " " + an) && (c = f(e)) : f(e), ((!s && c == u[u.length - 1]) || (s && c == u[0])) && Kn(e));
            })(e)
          : qn(t, "textarea") ||
            qn(t, "input") ||
            qn(t, "select") ||
      ...
      function bt(e, t, n, o) {
        var r = "";
        E.anchors.length && !E.lockAnchors && (e ? (null != n && (r = n), null == t && (t = e), yt(r + "/" + (i = t))) : (null != e && (i = t), yt(n))),
          Lt();
      }
      function yt(e) {
      ...
      function Ct() {
        ...
        n
          ...
          : (bn("error", "Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:"),
          ...
          Ln(u, Ft)
            ...
            : (E.continuousVertical &&
                ...
                bn("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
              !E.scrollOverflow ||
              ...
              E.scrollOverflow &&
                ...
                ((E.scrollOverflow = !1),
                bn("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")),
