  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      (t.exports = function (t, e, n, c) {
        ...
        "function" == typeof n && ("string" != typeof e || i(n, "name") || o(n, "name", e), (f(n).source = l.join("string" == typeof e ? e : ""))),
          t !== r ? (a ? !p && t[e] && (s = !0) : delete t[e], s ? (t[e] = n) : o(t, e, n)) : s ? (t[e] = n) : u(e, n);
      ...
      t.exports = function (t, e, n, f, h, g, b) {
        ...
        if (
          (P &&
            ...
            d !== Object.prototype &&
              x.next &&
              (l || i(x) === d || (u ? u(x, d) : "function" != typeof x[y] && a(x, y, m)), c(x, _, !0, !0), l && (p[_] = m))),
          "values" == h &&
            A &&
            "values" !== A.name &&
            ((E = !0),
          ...
          if (((w = { values: O("values"), keys: g ? j : O("keys"), entries: O("entries") }), b)) for (S in w) (!v && !E && S in T) || s(T, S, w[S]);
      ...
      t.exports = {
        getConstructor: function (t, e, n, s) {
          var f = t(function (t, r) {
              c(t, f, e), d(t, { type: e, index: o(null), first: void 0, last: void 0, size: 0 }), l || (t.size = 0), null != r && a(r, t[s], t, n);
            }),
            h = v(e),
            y = function (t, e, n) {
              var r,
              ...
              return (
                u
                  ? (u.value = n)
                  : ((i.last = u = { index: (o = p(e, !0)), key: e, value: n, previous: (r = i.last), next: void 0, removed: !1 }),
                    i.first || (i.first = u),
                    r && (r.next = u),
                    l ? i.size++ : t.size++,
                    "F" !== o && (i.index[o] = u)),
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        ...
        else for (p = (l = b.call(d)).next, n = new v(); !(f = p.call(l)).done; x++) (h = g ? i(l, m, [f.value, x], !0) : f.value), a(n, x, h);
        return (n.length = x), n;
      };
    },
    function (t, e, n) {
...
***************************************************************************** */
        ...
        return (
          ...
          function (n, r) {
            ...
            Object.defineProperty(n, r, {
              ...
              set: function (n) {
                Object.defineProperty(this, o, { value: A(n, t, e), enumerable: !1, writable: !0, configurable: !0 });
              },
              enumerable: !0,
              configurable: !0,
            });
      ...
      var M = function () {
        ...
        z = function (t, e, n) {
          ...
          return (
            (e = T(e) || 0),
            f(n) && ((l = !!n.leading), (i = (p = "maxWait" in n) ? k(T(n.maxWait) || 0, e) : i), (h = "trailing" in n ? !!n.trailing : h)),
            (g.cancel = function () {
        ...
        return (
          ...
          function (t, n, r) {
            ...
            n.split(/\s+/g).forEach(function (n) {
              e.push({ elem: t, eventName: n, handler: o }), t.addEventListener(n, o, N());
            });
          }
        );
      }
      ...
      function at(t) {
        ...
        o(n, "touchstart", function (n) {
          r.track(n), t.setMomentum(0, 0), 0 === i && ((e = t.options.damping), (t.options.damping = Math.max(e, 0.5))), i++;
        }),
        ...
        F(t)(
          ...
          function (e) {
            var n = (function (t) {
                ...
                return "wheelDeltaX" in t ? { x: t.wheelDeltaX / ft.OTHERS, y: t.wheelDeltaY / ft.OTHERS } : { x: 0, y: t.wheelDelta / ft.OTHERS };
              })(e),
              r = n.x,
              o = n.y;
            ...
            (t.prototype.getSize = function () {
              return (function (t) {
                ...
                return {
                  ...
                  content: { width: n.offsetWidth - n.clientWidth + n.scrollWidth + u, height: n.offsetHeight - n.clientHeight + n.scrollHeight + i },
                };
              })(this);
            }),
            (t.prototype.update = function () {
              ...
              var o = (function (t, e, n) {
                ...
                return (
                  ...
                  e === o.x && n === o.y
                    ...
                    : ((o.x = e),
                      (o.y = n),
                      U(a, { "-transform": "translate3d(" + -e + "px, " + -n + "px, 0)" }),
                      c.update(),
