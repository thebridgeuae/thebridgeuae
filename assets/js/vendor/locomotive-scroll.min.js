            ...
            value: function () {
              if (this.reloadOnContextChange) {
                (this.isMobile =
                  ...
                  ("MacIntel" === navigator.userAgentData.platform && navigator.maxTouchPoints > 1) ||
                ...
                if (
                  ...
                  ("desktop" == t ? this.smooth : this[t].smooth) != ("desktop" == this.context ? this.smooth : this[this.context].smooth) &&
            ...
            value: function (t) {
              ...
              Object.entries(this.els).forEach(function (l) {
                ...
                if (
                  (!c ||
                    (c.inView && !t) ||
                    ("horizontal" === e.direction ? o >= c.left && n < c.right && e.setInView(c, a) : s >= c.top && i < c.bottom && e.setInView(c, a)),
                  c && c.inView)
                )
              ...
              if (e || this.isScrolling || this.isDraggingScrollbar) {
                ...
                if (
                  (!this.animatingScroll &&
                    s > 100 &&
                    ((i < 0.5 && 0 != this.instance.delta[this.directionAxis]) || (i < 0.5 && 0 == this.instance.delta[this.directionAxis])) &&
                    this.stopScrolling(),
                  Object.entries(this.sections).forEach(function (i) {
                    var s = f(i, 2),
                      n = (s[0], s[1]);
                    n.persistent ||
                    (t.instance.scroll[t.directionAxis] > n.offset[t.directionAxis] && t.instance.scroll[t.directionAxis] < n.limit[t.directionAxis])
          ...
          },
          {
            ...
            value: function () {
              this.instance.delta[this.directionAxis] != this.instance.scroll[this.directionAxis]
                ? (this.instance.speed =
                    (this.instance.delta[this.directionAxis] - this.instance.scroll[this.directionAxis]) / Math.max(1, Date.now() - this.speedTs))
                : (this.instance.speed = 0);
            },
          },
          {
