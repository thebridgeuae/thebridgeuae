  ...
  var s = function (t, r) {
    ...
    a = function (t, n) {
      ...
      s(this.scope).is("[" + this.attr_name() + "]")
        ? (s(this.scope).data(this.attr_name(!0) + "-init", e.extend({}, this.settings, n || t, this.data_options(s(this.scope)))),
          ...
          ? (this.patch(this.libs[t]),
            n && n.hasOwnProperty(t)
              ? (typeof this.libs[t].settings != "undefined"
                  ...
                  : typeof this.libs[t].defaults != "undefined" && e.extend(!0, this.libs[t].defaults, n[t]),
                this.libs[t].init.apply(this.libs[t], [this.scope, n[t]]))
              : ((n = n instanceof Array ? n : new Array(n)), this.libs[t].init.apply(this.libs[t], n)))
          : function () {};
      },
      patch: function (e) {
        (e.scope = this.scope),
      ...
      utils: {
        ...
        register_media: function (t, n) {
          Foundation.media_queries[t] === r &&
            (e("head").append('<meta class="' + n + '">'), (Foundation.media_queries[t] = l(e("." + n).css("font-family"))));
        },
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.slider = {
      ...
      events: function () {
        ...
        e(this.scope)
          .off(".slider")
          .on("mousedown.fndtn.slider touchstart.fndtn.slider pointerdown.fndtn.slider", "[" + n.attr_name() + "] .range-slider-handle", function (t) {
            n.cache.active || (t.preventDefault(), n.set_active_slider(e(t.target)));
          })
          .on("mousemove.fndtn.slider touchmove.fndtn.slider pointermove.fndtn.slider", function (e) {
            !n.cache.active ||
              (e.preventDefault(),
              n.calculate_position(n.cache.active, e.pageX || e.originalEvent.clientX || e.originalEvent.touches[0].clientX || e.currentPoint.x));
          })
      ...
      set_ui: function (t, n) {
        var r = e.extend({}, this.settings, this.data_options(t.parent())),
          ...
          a = o * 100;
        Foundation.rtl && (u = -u),
          this.set_translate(t, u),
          t.siblings(".range-slider-active-segment").css("width", a + "%"),
          t.parent().attr(this.attr_name(), n),
          t.parent().trigger("change"),
          t.parent().children("input[type=hidden]").val(n),
          r.input_id != "" &&
            e(r.display_selector).each(function () {
      ...
      set_translate: function (t, n, r) {
        r
          ? e(t)
              ...
              .css("-ms-transform", "translateY(" + n + "px)")
              .css("-o-transform", "translateY(" + n + "px)")
              .css("transform", "translateY(" + n + "px)")
          : e(t)
              .css("-webkit-transform", "translateX(" + n + "px)")
              .css("-moz-transform", "translateX(" + n + "px)")
              .css("-ms-transform", "translateX(" + n + "px)")
              .css("-o-transform", "translateX(" + n + "px)")
      ...
      initialize_settings: function (t) {
        e.data(t, "bar", e(t).parent()),
          e.data(t, "bar_o", e(t).parent().offset().left),
          e.data(t, "bar_w", e(t).parent().outerWidth()),
          e.data(t, "handle_o", e(t).offset().left),
          e.data(t, "handle_w", e(t).outerWidth()),
          e.data(t, "settings", e.extend({}, this.settings, this.data_options(e(t).parent())));
      },
      set_initial_position: function (t) {
        var n = e.data(t.children(".range-slider-handle")[0], "settings"),
          r = n.initial ? n.initial : Math.floor(((n.end - n.start) * 0.5) / n.step) * n.step + n.start,
      ...
      set_value: function (t) {
        ...
        e("[" + n.attr_name() + "]", this.scope).each(function () {
          ...
          !e(this.scope).attr(n.attr_name()) || e(this.scope).attr(n.attr_name(), t),
          n.reflow();
      },
      reflow: function () {
        var t = this;
    ...
    Foundation.libs.joyride = {
      ...
      start: function () {
        ...
        this.settings.init || this.events(),
          (this.settings = n.data(this.attr_name(!0) + "-init")),
      ...
      tip_template: function (t) {
        ...
        return (
          ...
          n.first().attr(this.add_namespace("data-index"), t.index),
      ...
      timer_instance: function (t) {
        var n;
        return (
          (t === 0 && this.settings.start_timer_on_click && this.settings.timer > 0) || this.settings.timer === 0
            ? (n = "")
            : (n = e(this.settings.template.timer)[0].outerHTML),
          n
        );
      },
      ...
      show: function (t) {
        var n = null;
        this.settings.$li === r || e.inArray(this.settings.$li.index(), this.settings.pause_after) === -1
          ? (this.settings.paused ? (this.settings.paused = !1) : this.set_li(t),
            (this.settings.attempts = 0),
            this.settings.$li.length && this.settings.$target.length > 0
              ? (t && (this.settings.pre_ride_callback(this.settings.$li.index(), this.settings.$next_tip), this.settings.modal && this.show_modal()),
      ...
      scroll_to: function () {
        ...
        (n = e(t).height() / 2),
          ...
          r != 0 && e("html, body").animate({ scrollTop: r }, this.settings.scroll_speed, "swing");
      },
      paused: function () {
          ...
          /body/i.test(this.settings.$target.selector)
            ...
            : (this.bottom()
                ...
                ? (this.settings.$next_tip.css({
                  ...
                  this.nub_position(o, this.settings.tip_settings.nub_position, "left"))
                : this.left() &&
                  (this.settings.$next_tip.css({
                    top: this.settings.$target.offset().top,
      ...
      pos_phone: function (t) {
        ...
        s.removeClass("bottom").removeClass("top").removeClass("right").removeClass("left"),
          u && (this.settings.$next_tip.css("visibility", "hidden"), this.settings.$next_tip.show()),
          /body/i.test(this.settings.$target.selector)
            ? this.settings.$li.length && this.pos_modal(s)
            : this.top()
            ? (this.settings.$next_tip.offset({ top: this.settings.$target.offset().top - n - o }), s.addClass("bottom"))
            : (this.settings.$next_tip.offset({ top: this.settings.$target.offset().top + i + o }), s.addClass("top")),
          u && (this.settings.$next_tip.hide(), this.settings.$next_tip.css("visibility", "visible"));
      },
      ...
      expose: function () {
        ...
        (n = e(this.settings.template.expose)),
          ...
          n.css({ top: i.offset().top, left: i.offset().left, width: i.outerWidth(!0), height: i.outerHeight(!0) }),
          ...
          r.css({ top: i.offset().top, left: i.offset().left, width: i.outerWidth(!0), height: i.outerHeight(!0) }),
      ...
      startTimer: function () {
        ...
        this.settings.cookie_monster &&
          e.cookie(this.settings.cookie_name, "ridden", { expires: this.settings.cookie_expires, domain: this.settings.cookie_domain }),
    ...
    Foundation.libs.equalizer = {
      ...
      equalize: function (t) {
        ...
        s.before_height_change(),
          t.trigger("before-height-change"),
          r.height("inherit"),
          r.each(function () {
            var t = e(this);
            t.offset().top !== i && (n = !0);
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.dropdown = {
      ...
      events: function (n) {
        ...
        i(this.scope)
          .off(".dropdown")
          .on("click.fndtn.dropdown", "[" + this.attr_name() + "]", function (t) {
          ...
          .on("click.fndtn.dropdown", function (t) {
            ...
            if (
              ...
              n.length > 0 &&
              (i(t.target).is("[" + r.attr_name() + "-content]") || e.contains(n.first()[0], t.target))
            ) {
              t.stopPropagation();
              return;
            }
      ...
      toggle: function (e) {
        ...
        this.close.call(this, this.S("[" + this.attr_name() + "-content]").not(t)),
          t.hasClass(this.settings.active_class)
            ? this.close.call(this, t)
            : (this.close.call(this, this.S("[" + this.attr_name() + "-content]")), this.open.call(this, t, e));
      },
      resize: function () {
      ...
      css: function (e, t) {
        ...
        if (this.small()) {
          ...
          e.attr("style", "").removeClass("drop-left drop-right drop-top").css({ position: "absolute", width: "95%", "max-width": "none", top: n.top }),
      ...
      dirs: {
        ...
        top: function (e, t) {
          ...
          return (
            ...
            (e.outerWidth() < this.outerWidth() || n.small()) && n.adjust_pip(i, r),
            Foundation.rtl
              ? { left: r.left - this.outerWidth() + e.outerWidth(), top: r.top - this.outerHeight() }
        ...
        bottom: function (e, t) {
          ...
          return (
            (e.outerWidth() < this.outerWidth() || n.small()) && n.adjust_pip(i, r),
            n.rtl ? { left: r.left - this.outerWidth() + e.outerWidth(), top: r.top + e.outerHeight() } : { left: r.left, top: r.top + e.outerHeight() }
          );
        },
        left: function (e, t) {
      ...
      adjust_pip: function (e, t) {
        ...
        var r = ".f-dropdown.open:before",
          ...
          o = "left: " + (e - 1) + "px;";
        n.insertRule
          ? (n.insertRule([r, "{", s, "}"].join(" "), this.rule_idx), n.insertRule([i, "{", o, "}"].join(" "), this.rule_idx + 1))
          : (n.addRule(r, s, this.rule_idx), n.addRule(i, o, this.rule_idx + 1));
      },
      clear_idx: function () {
    ...
    Foundation.libs.clearing = {
      ...
      init: function (e, t, n) {
        ...
        Foundation.inherit(this, "throttle image_loaded"),
          this.bindings(t, n),
          r.S(this.scope).is("[" + this.attr_name() + "]")
            ? this.assemble(r.S("li", this.scope))
            : r.S("[" + this.attr_name() + "]", this.scope).each(function () {
      ...
      events: function (r) {
        var i = this,
          s = i.S;
        e(".scroll-container").length > 0 && (this.scope = e(".scroll-container")),
          s(this.scope)
            .off(".clearing")
            .on("click.fndtn.clearing", "ul[" + this.attr_name() + "] li", function (e, t, n) {
              var t = t || s(this),
                n = n || t,
                r = t.next("li"),
                ...
                u = s(e.target);
              e.preventDefault(),
                o || (i.init(), (o = t.closest("[" + i.attr_name() + "]").data(i.attr_name(!0) + "-init"))),
                n.hasClass("visible") && t[0] === n[0] && r.length > 0 && i.is_open(t) && ((n = r), (u = s("img", n))),
                i.open(u, t, n),
                i.update_paddles(n);
            })
        ...
        n(this.scope)
          ...
          .on("touchmove.fndtn.clearing", ".visible-img", function (e) {
            ...
            typeof r == "undefined" && (r = {}),
              (r.delta_x = e.touches[0].pageX - r.start_page_x),
              typeof r.is_scrolling == "undefined" &&
                (r.is_scrolling = !!(r.is_scrolling || Math.abs(r.delta_x) < Math.abs(e.touches[0].pageY - r.start_page_y)));
      ...
      open: function (t, r, i) {
        ...
        function d(t) {
          ...
          t.css("visibility", "visible"),
            ...
            f.show(),
            this.fix_height(i)
              .caption(s.S(".clearing-caption", f), s.S("img", i))
              .center_and_label(t, c)
              .shift(r, i, function () {
        ...
        return (
          this.rtl
            ...
            : (e.css({ marginLeft: -(e.outerWidth() / 2), marginTop: -(e.outerHeight() / 2) }),
              t.length > 0 && t.css({ marginLeft: -(t.outerWidth() / 2), marginTop: -(e.outerHeight() / 2) - t.outerHeight() - 10 })),
          this
        );
      },
      load: function (e) {
      ...
      shift: function (e, t, n) {
        ...
        t.index() !== i && !/skip/.test(s)
          ? /left/.test(s)
            ? (this.lock(), (l[o] = u + a), r.animate(l, 300, this.unlock()))
            : /right/.test(s) && (this.lock(), (l[o] = u - a), r.animate(l, 300, this.unlock()))
          : /skip/.test(s) &&
            ((f = t.index() - this.settings.up_count),
            this.lock(),
            f > 0 ? ((l[o] = -(f * a)), r.animate(l, 300, this.unlock())) : ((l[o] = 0), r.animate(l, 300, this.unlock()))),
          n();
      },
      direction: function (e, t, n) {
        var r = this.S("li", e),
          ...
          u;
        return (
          (this.settings.up_count = s),
          this.adjacent(this.settings.prev_index, o)
            ? o > s && o > this.settings.prev_index
              ? (u = "right")
              : o > s - 1 && o <= this.settings.prev_index
              ? (u = "left")
              : (u = !1)
            : (u = "skip"),
    ...
    var i = function () {},
      s = function (r, i) {
        ...
        (s.cache = {}),
          ...
          m || s.slides().first().addClass(i.active_slide_class),
          (s.update_slide_number = function (t) {
          ...
          (s.build_markup = function () {
            f.wrap('<div class="' + i.container_class + '"></div>'),
              (a = f.parent()),
              f.addClass(i.slides_container_class),
              f.addClass(i.animation),
              i.stack_on_small && a.addClass(i.stack_on_small_class),
              i.navigation_arrows &&
                (a.append(e('<a href="#"><span></span></a>').addClass(i.prev_class)), a.append(e('<a href="#"><span></span></a>').addClass(i.next_class))),
              i.timer &&
                ((h = e("<div>").addClass(i.timer_container_class)),
                h.append("<span>"),
                i.timer_show_progress_bar && h.append(e("<div>").addClass(i.timer_progress_class)),
                h.addClass(i.timer_paused_class),
                a.append(h)),
              i.slide_number &&
                ((l = e("<div>").addClass(i.slide_number_class)), l.append("<span></span> " + i.slide_number_text + " <span></span>"), a.append(l)),
              i.bullets &&
                ((c = e("<ol>").addClass(i.bullets_container_class)),
                a.append(c),
          ...
          (s._goto = function (e, t) {
            ...
            var r = s._prepare_direction(e),
              ...
              e = r[3];
            if (r === !1) return !1;
            f.trigger("before-slide-change.fndtn.orbit"),
              i.before_slide_change(),
              (p = e),
              u.css("transitionDuration", i.animation_speed + "ms"),
              a.css("transitionDuration", i.animation_speed + "ms");
            var l = function () {
              var r = function () {
                t === !0 && s.cache.timer.restart(),
                  s.update_slide_number(p),
                  a.addClass(i.active_slide_class),
                  s.update_active_link(e),
                  f.trigger("after-slide-change.fndtn.orbit", [{ slide_number: p, total_slides: n.length }]),
                  i.after_slide_change(p, n.length),
                  setTimeout(function () {
                    s.cache.animating = !1;
                  }, 100);
              };
          ...
          (s.toggle_timer = function () {
            ...
            e.hasClass(i.timer_paused_class)
              ? (typeof s.cache.timer == "undefined" && (s.cache.timer = s.create_timer()), s.cache.timer.start())
              : typeof s.cache.timer == "object" && s.cache.timer.stop();
          }),
          (s.init = function () {
            s.build_markup(),
              i.timer && ((s.cache.timer = s.create_timer()), Foundation.utils.image_loaded(this.slides().children("img"), s.cache.timer.start)),
              (d = new u(i, f));
            if (m) {
            ...
            a.on("click", "." + i.next_class, s.next),
              a.on("click", "." + i.prev_class, s.prev),
              i.next_on_click && a.on("click", "[data-orbit-slide]", s.link_bullet),
              a.on("click", s.toggle_timer),
              i.swipe &&
                f
                  .on("touchstart.fndtn.orbit", function (e) {
                    ...
                    e.touches || (e = e.originalEvent),
                      e.preventDefault(),
                      e.stopPropagation(),
                      (s.cache.start_page_x = e.touches[0].pageX),
                      (s.cache.start_page_y = e.touches[0].pageY),
                      (s.cache.start_time = new Date().getTime()),
                      (s.cache.delta_x = 0),
                      (s.cache.is_scrolling = null),
                      (s.cache.direction = null),
                      s.stop_timer();
                  })
                  .on("touchmove.fndtn.orbit", function (e) {
                    ...
                    requestAnimationFrame(function () {
                      e.touches || (e = e.originalEvent);
                      if (e.touches.length > 1 || (e.scale && e.scale !== 1)) return;
                      (s.cache.delta_x = e.touches[0].pageX - s.cache.start_page_x),
                        s.cache.is_scrolling === null &&
                          (s.cache.is_scrolling = !!(
                      ...
                      if (i.animation === "slide") {
                        var r, o;
                        (r = (s.cache.delta_x / a.width()) * 100),
                          r >= 0 ? (o = -(100 - r)) : (o = 100 + r),
                          s.cache.current.css("transform", "translate3d(" + r + "%,0,0)"),
              ...
              e(n).on("click", "[data-orbit-link]", s.link_custom),
              e(t).on("load resize", s.compute_dimensions);
            var l = this.slides().find("img");
            Foundation.utils.image_loaded(l, s.compute_dimensions),
              Foundation.utils.image_loaded(l, function () {
        ...
        (this.update_progress = function (e) {
          ...
          (this.start = function () {
            ...
            (f = f === -1 ? i : f),
              ...
              o && ((u = new Date().getTime()), s.animate({ width: "100%" }, f, "linear")),
      ...
      u = function (e, t) {
        ...
        (this.next = function (r, i, s) {
          Modernizr.csstransitions
            ? i.on(n, function (e) {
                i.unbind(n),
                  r.removeClass("active animate-out"),
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.offcanvas = {
      ...
      events: function () {
        ...
        t(this.scope)
          .off(".offcanvas")
          .on("click.fndtn.offcanvas", ".left-off-canvas-toggle", function (t) {
      ...
      events: function () {
        ...
        e(this.scope)
          ...
          .on("click.fndtn.alert", "[" + this.attr_name() + "] a.close", function (e) {
            ...
            e.preventDefault(),
              "transitionend" in t || "webkitTransitionEnd" in t || "oTransitionEnd" in t
                ? (i.addClass("alert-close"),
                  i.on("transitionend webkitTransitionEnd oTransitionEnd", function (e) {
        ...
        directives: {
          replace: function (t, n, r) {
            ...
            return /\.(gif|jpg|jpeg|tiff|png)([?#].*)?/i.test(n)
              ? (e(t).css("background-image", "url(" + n + ")"), t.data("interchange-last-path", n), r(n))
              : e.get(n, function (e) {
      ...
      resize: function () {
        ...
        for (var n in t)
          if (t.hasOwnProperty(n)) {
            ...
            r &&
              this.settings.directives[r.scenario[1]].call(this, r.el, r.scenario[0], function () {
    ...
    Foundation.libs["magellan-expedition"] = {
      ...
      events: function () {
        var n = this,
          r = n.S,
          i = n.settings;
        n.set_expedition_position(),
          r(n.scope)
            .off(".magellan")
            .on("click.fndtn.magellan", "[" + n.add_namespace("data-magellan-arrival") + '] a[href^="#"]', function (t) {
              t.preventDefault();
              ...
              (u -= r.outerHeight()),
                e("html, body")
                  .stop()
                  .animate({ scrollTop: u }, 700, "swing", function () {
                    history.pushState ? history.pushState(null, null, "#" + s) : (location.hash = "#" + s);
                  });
            })
            .on("scroll.fndtn.magellan", n.throttle(this.check_for_arrivals.bind(this), i.throttle_delay)),
          e(t).on("resize.fndtn.magellan", n.throttle(this.set_expedition_position.bind(this), i.throttle_delay));
      },
      ...
      update_expedition_positions: function () {
        ...
        e("[" + this.attr_name() + "=fixed]", n.scope).each(function () {
          ...
          if (r >= i) {
            ...
            s.length === 0 && ((s = t.clone()), s.removeAttr(n.attr_name()), s.attr(n.add_namespace("data-magellan-expedition-clone"), ""), t.before(s)),
      ...
      offsets: function (t, n) {
        var r = this,
          ...
          s = n;
        return t
          .find("[" + r.add_namespace("data-magellan-arrival") + "]")
          .map(function (n, o) {
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.accordion = {
      ...
      events: function () {
        ...
        n(this.scope)
          .off(".fndtn.accordion")
          .on("click.fndtn.accordion", "[" + this.attr_name() + "] dd > a", function (r) {
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.topbar = {
      ...
      init: function (t, n, r) {
        ...
        i.register_media("topbar", "foundation-mq-topbar"),
          ...
          i.S("[" + this.attr_name() + "]", this.scope).each(function () {
            ...
            t.data("index", 0);
            var o = t.parent();
            o.hasClass("fixed") || i.is_sticky(t, o, n)
              ? ((i.settings.sticky_class = n.sticky_class),
                (i.settings.sticky_topbar = t),
                t.data("height", o.outerHeight()),
                t.data("stickyoffset", o.offset().top))
              : t.data("height", t.outerHeight()),
              n.assembled || i.assemble(t),
              n.is_hover ? i.S(".has-dropdown", t).addClass("not-click") : i.S(".has-dropdown", t).removeClass("not-click"),
      ...
      is_sticky: function (e, t, n) {
        ...
        return r && n.sticky_on === "all"
          ? !0
          : r && this.small() && n.sticky_on === "small"
          ? !0
          : r && this.medium() && n.sticky_on === "medium"
          ? !0
          : r && this.large() && n.sticky_on === "large"
          ? !0
          : !1;
      },
      toggle: function (n) {
        ...
        r.breakpoint() &&
          (r.rtl ? (o.css({ right: "0%" }), e(">.name", o).css({ right: "100%" })) : (o.css({ left: "0%" }), e(">.name", o).css({ left: "100%" })),
          r.S("li.moved", o).removeClass("moved"),
          i.data("index", 0),
          i.toggleClass("expanded").css("height", "")),
          s.scrolltop
            ? i.hasClass("expanded")
              ? i.parent().hasClass("fixed") &&
                (s.scrolltop
                  ? (i.parent().removeClass("fixed"), i.addClass("fixed"), r.S("body").removeClass("f-topbar-fixed"), t.scrollTo(0, 0))
                  : i.parent().removeClass("expanded"))
              : i.hasClass("fixed") && (i.parent().addClass("fixed"), i.removeClass("fixed"), r.S("body").addClass("f-topbar-fixed"))
            : (r.is_sticky(i, i.parent(), s) && i.parent().addClass("fixed"),
              i.parent().hasClass("fixed") &&
                (i.hasClass("expanded")
                  ? (i.addClass("fixed"), i.parent().addClass("expanded"), r.S("body").addClass("f-topbar-fixed"))
        ...
        i(this.scope)
          ...
          .on("click.fndtn.topbar", "[" + this.attr_name() + "] li.has-dropdown", function (t) {
            ...
            t.stopImmediatePropagation(),
              n.hasClass("hover")
                ? (n.removeClass("hover").find("li").removeClass("hover"), n.parents("li.hover").removeClass("hover"))
                : (n.addClass("hover"),
                  e(n).siblings().removeClass("hover"),
                  s[0].nodeName === "A" && s.parent().hasClass("has-dropdown") && t.preventDefault());
          })
          .on("click.fndtn.topbar", "[" + this.attr_name() + "] .has-dropdown>a", function (e) {
            if (r.breakpoint()) {
              ...
              n.data("index", n.data("index") + 1),
                u.addClass("moved"),
                r.rtl
                  ? (s.css({ right: -(100 * n.data("index")) + "%" }), s.find(">.name").css({ right: 100 * n.data("index") + "%" }))
                  : (s.css({ left: -(100 * n.data("index")) + "%" }), s.find(">.name").css({ left: 100 * n.data("index") + "%" })),
        ...
        e.S("[" + this.attr_name() + "]").each(function () {
          ...
          e.is_sticky(t, i, r) &&
            (i.hasClass("fixed")
              ? (i.removeClass("fixed"),
                (s = i.offset().top),
                e.S(n.body).hasClass("f-topbar-fixed") && (s -= t.data("height")),
                t.data("stickyoffset", s),
                i.addClass("fixed"))
              : ((s = i.offset().top), t.data("stickyoffset", s)));
        });
      },
      breakpoint: function () {
      ...
      assemble: function (t) {
        ...
        i.detach(),
          n.S(".has-dropdown>a", i).each(function () {
            var t = n.S(this),
      ...
      update_sticky_positioning: function () {
        ...
        if (r.settings.sticky_topbar && r.is_sticky(this.settings.sticky_topbar, this.settings.sticky_topbar.parent(), this.settings)) {
          ...
          r.S(e).hasClass("expanded") ||
            (n.scrollTop() > i
              ? r.S(e).hasClass("fixed") || (r.S(e).addClass("fixed"), r.S("body").addClass("f-topbar-fixed"))
              : n.scrollTop() <= i && r.S(e).hasClass("fixed") && (r.S(e).removeClass("fixed"), r.S("body").removeClass("f-topbar-fixed")));
        }
      },
      off: function () {
    ...
    Foundation.libs.tab = {
      ...
      init: function (e, t, n) {
        ...
        this.bindings(t, n),
          ...
          i("[" + this.attr_name() + "] > dd.active > a", this.scope).each(function () {
      ...
      events: function () {
        ...
        n(this.scope)
          .off(".tab")
          .on("click.fndtn.tab", "[" + this.attr_name() + "] > dd > a", function (t) {
            var r = n(this)
              .closest("[" + e.attr_name() + "]")
      ...
      toggle_active_tab: function (n, i) {
        ...
        if (c.deep_linking) {
          ...
          i != r ? (t.location.hash = i) : (t.location.hash = a),
            c.scroll_to_content
              ? i == r || i == a
                ? n.parent()[0].scrollIntoView()
                : s(a)[0].scrollIntoView()
              : (i == r || i == a) && e("body,html").scrollTop(h);
        }
        n.addClass(c.active_class).triggerHandler("opened"),
          l.removeClass(c.active_class),
          f.siblings().removeClass(c.active_class).end().addClass(c.active_class),
          c.callback(n),
          f.triggerHandler("toggled", [n]),
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.abide = {
      ...
      check_validation_and_apply_styles: function (t) {
        ...
        while (n--) {
          var o = t[n][0],
            ...
            v,
            m;
          o.getAttribute(this.add_namespace("data-equalto")) && (l = "equalTo"),
            f.is("label") ? (v = f.parent()) : (v = f),
            c && u
              ? r.push(this.valid_radio(o, u))
              : h && u
              ? r.push(this.valid_checkbox(o, u))
              : l
              ? ((m = this.settings.validators[l].apply(this, [o, u, v])),
                r.push(m),
                m ? (this.S(o).removeAttr(this.invalid_attr), v.removeClass("error")) : (this.S(o).attr(this.invalid_attr, ""), v.addClass("error")))
              : (t[n][1].test(a) && d) || (!u && o.value.length < 1) || e(o).attr("disabled")
              ? (this.S(o).removeAttr(this.invalid_attr),
                v.removeClass("error"),
                p.length > 0 && s.error_labels && p.removeClass("error"),
                r.push(!0),
                e(o).triggerHandler("valid"))
              : (this.S(o).attr(this.invalid_attr, ""),
                v.addClass("error"),
                p.length > 0 && s.error_labels && p.addClass("error"),
                r.push(!1),
                e(o).triggerHandler("invalid"));
        }
        return r;
      },
      ...
      valid_radio: function (e, t) {
        ...
        for (var o = 0; o < i; o++)
          s
            ? this.S(r[o]).removeAttr(this.invalid_attr).parent().removeClass("error")
            : this.S(r[o]).attr(this.invalid_attr, "").parent().addClass("error");
        return s;
      },
    ...
    Foundation.libs.tooltip = {
        ...
        n.create(this.S(t)),
          e(this.scope)
            ...
            .on(
              ...
              function (t) {
                ...
                if (i.hasClass("open")) Modernizr.touch && /touchstart|MSPointerDown/i.test(t.type) && t.preventDefault(), n.hide(i);
                  ...
                  !s.disable_for_touch &&
                    Modernizr.touch &&
                    /touchstart|MSPointerDown/i.test(t.type) &&
                    (t.preventDefault(), r(s.tooltip_class + ".open").hide(), (o = !0)),
                    /enter|over/i.test(t.type)
                      ...
                      ? (clearTimeout(this.timer), n.hide(i))
                      : n.showTip(i);
                }
              }
            )
            .on("mouseleave.fndtn.tooltip touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip", "[" + this.attr_name() + "].open", function (t) {
              ...
              e(this).data("tooltip-open-event-type") == "mouse" && /MSPointerDown|touchstart/i.test(t.type)
                ? n.convert_to_touch(e(this))
                : n.hide(e(this));
            })
      ...
      create: function (n) {
        ...
        o.addClass(u).appendTo(i.append_to),
          Modernizr.touch &&
            (o.append('<span class="tap-to-close">' + i.touch_close_text + "</span>"),
            o.on("touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip", function (e) {
              r.hide(n);
            })),
      ...
      reposition: function (t, n, r) {
        ...
        n.css("visibility", "hidden").show(),
          ...
          (o = s.outerHeight()),
          (u = s.outerHeight()),
          this.small() ? n.css({ width: "100%" }) : n.css({ width: i ? i : "auto" }),
        ...
        if (this.small())
          ...
          Foundation.rtl && (s.addClass("rtl"), (l = t.offset().left + t.outerWidth() - n.outerWidth())),
            ...
            r && r.indexOf("tip-top") > -1
              ? (Foundation.rtl && s.addClass("rtl"), f(n, t.offset().top - n.outerHeight(), "auto", "auto", l).removeClass("tip-override"))
              : r && r.indexOf("tip-left") > -1
              ? (f(n, t.offset().top + t.outerHeight() / 2 - n.outerHeight() / 2, "auto", "auto", t.offset().left - n.outerWidth() - o).removeClass(
                  "tip-override"
                ),
                s.removeClass("rtl"))
              : r &&
                r.indexOf("tip-right") > -1 &&
                (f(n, t.offset().top + t.outerHeight() / 2 - n.outerHeight() / 2, "auto", "auto", t.offset().left + t.outerWidth() + o).removeClass(
                  "tip-override"
                ),
                s.removeClass("rtl"));
        }
      ...
      convert_to_touch: function (t) {
        ...
        r.find(".tap-to-close").length === 0 &&
          (r.append('<span class="tap-to-close">' + i.touch_close_text + "</span>"),
          r.on("click.fndtn.tooltip.tapclose touchstart.fndtn.tooltip.tapclose MSPointerDown.fndtn.tooltip.tapclose", function (e) {
            n.hide(t);
          })),
